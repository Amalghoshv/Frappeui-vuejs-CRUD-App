<template>
  <div>
   <h3 class="p-2 font-bold">Hello Admin</h3>
    ...
    <div class="dashboard flex">
        <div class="pl-6">
          <div class="mx-auto pt-4">
            ...
            <div
              class="flex flex-col bg-white rounded-md border border-blue-500 mb-4"
            >
              <div class="overflow-x-auto block">
                <div class="p-1.5 w-50 inline-block align-middle">
                  <div>
                    <tabs
                      variant="underline"
                      v-model="activeTab"
                            ...
                            <tbody class="divide-y divide-gray-200">
                              <tr>
                                ...
                                <td
                                  class="px-6 py-4 text-sm text-gray-800 whitespace-nowrap"
                                >
                                  <Badge type="green">Generated</Badge>
                                </td>
                              </tr>
                              <tr>
                                <td
                              ...
                              <tr>
                                ...
                                <td
                                  class="px-6 py-4 text-sm text-gray-800 whitespace-nowrap"
                                >
                                  <Badge type="red">Completed</Badge>
                                </td>
                              </tr>
                              <tr>
                                <td
                        ...
                        ><tbody class="divide-y divide-gray-200">
                          <tr>
                            ...
                            <td
                              class="px-6 py-4 text-sm text-gray-800 whitespace-nowrap"
                            >
                              <Badge type="indigo">Processed</Badge>
                            </td>
                          </tr>
                          <tr>
                            <td
          ...
          <div class="border border-blue-500 bg-white rounded-md">
            <div class="flex justify-between rounded">
              <div><h3 class="bg-white m-2">Activity</h3></div>
              <div>
                <button
                 
                  class="border border-yellow-500 p-1 mx-2 my-2 rounded-md"
                >
                  View full calender
                </button>
              </div>
            ...
            <div>
              <tabs variant="underline" v-model="activeTab" class="p-5">
                ...
                >
                <tab name="third" title="Leave Request">
                  NO REQUESTS AVAILABLE
                </tab>
                <tab name="fourth" title="Renewals">
                  <tbody class="divide-y divide-gray-200">
                    <tr>
                      <td
                        class="px-6 py-4 text-sm font-medium text-gray-800 whitespace-nowrap"
        ...
        <!-- <Calendar/> -->
          ...
          <div class="mt-5">
            <div class="card w-10">
              <h2 class="card-heading">Payments Book</h2>
          ...
          <div class="mt-5">
            <div class="card2">
              <h2 class="card2-heading">Upcoming</h2>
...
export default{
  ...
  mounted(){
    ...
    fetchTenant() {
      axios.get('https://propfi-erp.enfono.com/api/resource/Tenant',{
        headers:{
          Authorization: 'token 2e83ad6ac981c0e:6d9c75d97aee1c7'
        }
      })
    ...
    fetchProperties() {
      axios.get('https://propfi-erp.enfono.com/api/resource/Properties',{
        headers:{
          Authorization: 'token 2e83ad6ac981c0e:6d9c75d97aee1c7'
        }
      })
