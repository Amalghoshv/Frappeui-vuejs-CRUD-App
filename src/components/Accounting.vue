<template>
   <div >
    ...
    <div>
        <h1 class="m-2 mb-5 text-h5">Customer Ledge Summary</h1>

    </div>
    <div class="tables  bg-white">
        <v-row>
      <v-col cols="2">
        <v-text-field class="custom-text-field" label="enfono" dense></v-text-field>
        
      </v-col>
      <v-col cols="2">
        <v-text-field type="date" class="custom-text-field" dense ></v-text-field>
      </v-col>
      <v-col cols="2">
...
export default {
    ...
    methods: {
        fetchReport() {
            axios
                .get("https://propfi-erp.enfono.com/api/method/frappe.desk.query_report.run?report_name=Debtor Report", {
                headers: {
        ...
        fetchSummary() {
            axios
                .get("https://propfi-erp.enfono.com/api/method/frappe.desk.query_report.run?report_name=Customer Ledger Summary&filters={\"from_date\":\"2023-03-01\"}", {
                headers: {
                    Authorization: "token 2e83ad6ac981c0e:6d9c75d97aee1c7",
                },
            })
