<template>
    ...
    <div 
      class="relative md:flex  overflow-hidden border border-cyan-300 sidebar"
      id="sidebar"
    >
      <div
        :class="isOpen ? 'w-20' : 'w-60'"
        class="flex flex-col h-25 p-3 duration-300 bg-white shadow"
      >
        <div class="flex-1 h-screen overflow-y-auto cont">
          <div class="flex items-center justify-between w-32 h-32">
            <img
              v-if="showText"
              src="https://erp-demo.vercel.app/static/media/Web%20Logo%20(2).e7e1d3e7854e0a84f798.png"
            />
          ...
          <div class="flex-1" >
            <ul class="pt-2 pb-4 space-y-1 text-sm">
              <router-link to="/dashboard"><li :class="{ 'selected': selectedItem === 'item1' }" @click="selectItem('item1')"   class="rounded-sm items   " ><div class="slc">
                  <a
                    href="#"
                  ...
                  >
                    <svg
                      ...
                      stroke-width="1.5"
                      stroke="currentColor"
                      class="w- h-6 text-black text-center"
                    >
                      <path
                    ...
                    <span v-if="showText" class="text-black text-center text-xl"
                      >Dashboard </span
                    >
                  </a>
                </div>
              ...
              <router-link to="/properties"> <li class="rounded-sm items properties" :class="{ 'selected': selectedItem === 'item2' }" @click="selectItem('item2')">
                <a href="#" class="flex items-center p-2 space-x-3">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
...
export default {
  ...
  return { 
    ...
    //     { id: 2, label: 'Properties', route: '/properties' },
    //     { id: 3, label: 'Units', route: '/units' },
  ...
  methods: {
    ...
    toggleSidebar() {
      ...
      container.addEventListener('transitionend', this.resetButton)
    },
    // handleTabClick(tabName) {
    //   this.$emit('tabSelected', tabName); // Emit the selected tab to the parent component
    // },
    /* selectItem(item) {
      this.$emit('item-selected', item.route)
    } */
  },
  components:{
    Button,
